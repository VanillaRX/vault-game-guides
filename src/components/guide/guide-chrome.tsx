...
export function GuideTrans({ en, zh }: { en: string; zh?: string }) {
  ...
  const map: Record<string, string> = {
    ...
    "Processing": "加工",
    "Optimal Ratio": "最优比例",
    "Population Supported": "支持人口",
    "Input Chain": "投入链",
    "Used In": "用途",
    "Requires": "需求",
    "End Product": "最终产品",
    "Required Buildings": "所需建筑",
    "Villager Tier": "居民等级",
    "Crop": "作物",
    "Plant → Harvest": "种植→收获",
    "Yield": "产量",
    ...
    "Mood Effect": "心情效果",
    "Duration": "持续时间",
    "How to Get / Counter": "获取/应对",
    "Room Type": "房间类型",
    "Minimum Size": "最小尺寸",
    "Target Impressiveness": "目标豪华度",
    "How to Achieve": "实现方法",
    "Job Type": "工作类型",
    "Who Gets It": "谁来做",
    "Why": "原因",
    "Major Adjacency (+2)": "主要加成(+2)",
    "Minor Adjacency (+1)": "次要加成(+1)",
    "Doubling Policy": "翻倍政策",
    "District": "区域",
    "Unlock": "解锁科技",
    "Wonder": "奇观",
    "Best Adjacent To": "最佳相邻",
    "Strategic Reason": "策略原因",
    "Civ": "文明",
    "Unique District": "独特区域",
    "Replaces": "替换",
    "Adjacency Advantage": "加成优势",
    "Turret Type": "炮塔类型",
    "Range": "射程",
    "Damage": "伤害",
    "Best Placement": "最佳摆放",
    "Target Pal": "目标帕鲁",
    "Breeding Chain": "繁殖链",
    "Warehouse Level": "仓库等级",
    "Carts": "运输车",
    "Max Range": "最大范围",
    "Buildings Supported": "支持建筑数",
    "Industry": "产业",
    "Best Specialist": "最佳专家",
    "Source": "获取来源",
    "Power Plant Type": "发电站类型",
    "Radius": "半径",
    "Fuel": "燃料",
    "Productivity Bonus": "生产力加成",
    "Tower Type": "箭塔类型",
    "Garrison": "驻军",
    "Unit": "单位",
    "Equipment": "装备",
